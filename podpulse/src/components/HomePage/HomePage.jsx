...
const HomePage = ({ setCurrentAudio }) => {
  ...
  return (
    <div className="container mx-auto py-6 px-4 sm:px-6 md:px-8 bg-gray-300">
      {/* Page title and logo */}
      <div className="text-center mb-8">
        <h1 className="text-2xl sm:text-4xl font-bold text-oxford-blue mb-4">
          Catch the Pulse of Trending Podcasts
        </h1>
        <img
          src={logo}
          alt="Podcast Logo"
          className="mx-auto mb-6 w-32 h-32 sm:w-48 sm:h-48 rounded-full shadow-lg bg-gray-200 animate-pulse"
        />
      </div>
